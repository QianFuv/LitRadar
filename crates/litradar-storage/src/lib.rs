...
pub use auth::{
    ...
    insert_personal_access_token_with_audit, issue_invite_code_with_audit, list_access_tokens,
    random_hex, register_user_with_invite, register_user_with_invite_and_audit,
    replace_login_access_token, replace_login_access_token_with_audit,
