...
pub use delivery::{
    ...
    release_delivery_dedupe_reservations, release_delivery_lease, renew_delivery_lease,
    renew_delivery_run, request_delivery_run_cancellation, reserve_delivery_dedupe,
    resolve_delivery_dedupe, start_delivery_run, DeliveryCheckpointRecord,
