...
mod tests {
    ...
    fn committed_bundle_manifest_matches_every_tracked_catalog() {
        ...
        assert!(chinese
            .legacy_sha256
            .contains("5b28d5cd1ac82cc8c9bbc2c7163fc4afcc0b80fb9e86fb404bb782b23684d05d"));
        assert!(chinese
            .legacy_sha256
        ...
        assert!(chinese
            .legacy_sha256
            .contains("44ef81109fa226959c39a13a557b72c2ad5d0f0882206fe49bbf1a59e4320318"));
        assert!(chinese
            .legacy_sha256
            .contains("aad69121a2cba5f9be026345f371e8f17974ee2f5afbe4a1e24bac46c322dc7c"));
        let english = bundle
            .catalogs
            .iter()
