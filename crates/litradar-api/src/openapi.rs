...
#[openapi(
    ...
    paths(
        ...
        crate::routes::auth::revoke_invite_code,
        crate::routes::auth::rotate_invite_code,
        ...
        crate::routes::favorites::list_folder_article_page,
        ...
        crate::routes::admin::revoke_admin_invite_code,
        ...
        crate::routes::admin::get_provider_catalog,
    ...
    components(schemas(
        litradar_domain::AdminInviteCodeCreate,
        ...
        litradar_domain::FavoriteArticlePage,
        ...
        litradar_domain::InviteCodeStatus,
        ...
        litradar_domain::ProviderCapabilityInfo,
        litradar_domain::ProviderCatalogInfo,
        ...
        litradar_domain::RuntimeSettingApplyMode,
        litradar_domain::RuntimeSettingControl,
        litradar_domain::RuntimeSettingGroup,
...
mod tests {
    ...
    const EXPECTED_OPERATIONS: &[(&str, &str)] = &[
        ...
        ("/api/auth/invite-code", "delete"),
        ("/api/auth/invite-code/rotate", "post"),
        ...
        ("/api/favorites/folders/{folder_id}/articles/page", "get"),
        ...
        ("/api/tracking/push-weekly/runs/{run_id}", "get"),
        ("/api/tracking/push-weekly/runs/{run_id}/cancel", "post"),
        ("/api/tracking/notification-settings", "get"),
        ("/api/tracking/notification-settings", "put"),
        ("/api/tracking/ai-endpoints", "get"),
        ("/api/admin/users", "get"),
        ...
        ("/api/admin/provider-catalog", "get"),
