...
const ENVELOPE_PREFIX: &str = "psenc:v1:";
...
mod tests {
    ...
    fn envelope_round_trip_binds_ciphertext_to_context() {
        ...
        assert!(envelope.starts_with("psenc:v1:"));
    ...
    fn migration_is_transactional_when_an_existing_envelope_is_invalid() {
        ...
        connection
            .execute_batch(
                ...
                INSERT INTO notification_settings VALUES (1, 'plain-one', 'psenc:v1:bad', '');",
            )
